...
@Component({
  selector: 'app-actividad-premium',
  templateUrl: './actividad-premium.page.html',
  styleUrls: ['./actividad-premium.page.scss'],
})
export class ActividadPremiumPage implements OnInit{
  ...
  async obtenerDatosActividad() {
    try {
      ...
      console.log('Actividades encontradas para rutUsuario:', this.actividades);
    } catch (error) {
  ...
  ionViewWillEnter() {
    ...
    this.selectedTab = 'actividad-premium';
  }
  tabChanged() {
